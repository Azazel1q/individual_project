...
$id_prod = !empty($_GET['prod_id'])?$_GET['prod_id']:mysqli_fetch_array(mysqli_query($con, "select id_prod from products limit 1"))['id_prod'];
...
<section class="edit_count_form">
	...
	<p><?=$prod['kol'];?></p>
	<p>Введите добавляемое количество продукции</p>
...
<script>
	...
	setTimeout(function(){
		window.location.href = 'edit_count_prod.php?prod_id=<?=$id_prod;?>';
	}, 2000);
	}
</script>